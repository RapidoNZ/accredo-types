...
export interface ICProductPending {
     ...
     * @memberof ICProductPending
     */
    'SourceType'?: ICProductPendingSourceTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof ICProductPending
...
export const ICProductPendingSourceTypeEnum = {
    Invoice: 'Invoice',
    Credit: 'Credit',
    Shipment: 'Shipment',
    Transfer: 'Transfer',
...
export type ICProductPendingSourceTypeEnum = typeof ICProductPendingSourceTypeEnum[keyof typeof ICProductPendingSourceTypeEnum];
