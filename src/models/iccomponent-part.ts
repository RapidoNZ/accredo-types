...
export interface ICComponentPart {
     ...
     * @memberof ICComponentPart
     */
    'PartType'?: ICComponentPartPartTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof ICComponentPart
...
export const ICComponentPartPartTypeEnum = {
    Variable: 'Variable',
    Fixed: 'Fixed',
    Narrative: 'Narrative'
} as const;

export type ICComponentPartPartTypeEnum = typeof ICComponentPartPartTypeEnum[keyof typeof ICComponentPartPartTypeEnum];
